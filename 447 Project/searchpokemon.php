...
$mysqli->query('DELETE FROM Filtered WHERE Player="' . $_SESSION['user'] . '"');
$query = 'INSERT INTO Filtered SELECT ID, "' . $_SESSION["user"] . '" FROM Pokemon';
$nameq = '';
$ptypeq = '';
$type2q = '';
...
$_SESSION['min_atk'] = $attack;
$_SESSION['min_def'] = $defense;
$_SESSION['min_spa'] = $spa;
$_SESSION['min_spd'] = $spd;
$_SESSION['min_speed'] = $speed;
$_SESSION['min_hp'] = $hp;
