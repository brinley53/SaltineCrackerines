...
<head>
    ...
    <script src="http://saltine.wuaze.com/js/autocomplete.js?v=<? echo time(); ?>"></script>
</head>
<body>
    <div class="header_bar">
        <!-- back button -->
        <input class="back_button" type="submit" value="Back" onclick="window.location='./home.php'">
        <!-- header text -->
    ...
    <div class="sections">
        ...
        <div class="right_section">
                    ...
                    <div class="weak_strong_against_block">
                        ...
                        <div class="strong_against_block" id="strong_against_block">
                            <div class="hidden_strong_against" style="display: none;">
                                <input type="checkbox" name="strength[]" id="sBug" value="Bug" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Bug', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sDragon" value="Dragon" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Dragon', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sElectric" value="Electric" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Electric', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sFighting" value="Fighting" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Fighting', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sFire" value="Fire" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Fire', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>

                                <input type="checkbox" name="strength[]" id="sFlying" value="Flying" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Flying', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sGhost" value="Ghost" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ghost', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sGrass" value="Grass" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Grass', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sGround" value="Ground" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ground', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sIce" value="Ice" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ice', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>

                                <input type="checkbox" name="strength[]" id="sNormal" value="Normal" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Normal', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sPoison" value="Poison" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Poison', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sPsychic" value="Psychic" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Psychic', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sRock" value="Rock" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Rock', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                                <input type="checkbox" name="strength[]" id="sWater" value="Water" <?php echo isset($_SESSION['form_data']['strength']) && in_array('Water', $_SESSION['form_data']['strength']) ? 'checked' : ''; ?>>
                            </div>
                            <p class="type_text">Types strong against</p>
                            <div class="strong_against_row">
                                <input type="button" onclick="selectType(this, 's');" value="Bug" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Bug', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Dragon" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Dragon', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Electric" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Electric', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Fighting" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Fighting', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Fire" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Fire', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                            </div>
                            <div class="strong_against_row">
                                <input type="button" onclick="selectType(this, 's');" value="Flying" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Flying', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Ghost" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ghost', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Grass" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Grass', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Ground" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ground', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Ice" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Ice', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                            </div>
                            <div class="strong_against_row">
                                <input type="button" onclick="selectType(this, 's');" value="Normal" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Normal', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Poison" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Poison', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Psychic" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Psychic', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Rock" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Rock', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                                <input type="button" onclick="selectType(this, 's');" value="Water" style="background-color: <?php echo isset($_SESSION['form_data']['strength']) && in_array('Water', $_SESSION['form_data']['strength']) ? 'rgb(0, 0, 0)' : ''; ?>">
                            </div>                            
                        </div>
                    </div>
                    ...
                    <div class="min_values">
                        <div class="slider_row">
                            <div class="individual_slider_block min_attack">
                                <!-- attack max = 190 -->
                                <p class="slider_text">Min. Attack: <?php echo isset($_SESSION['min_atk']) ? $_SESSION['min_atk'] : 0; ?></p>
                                <input type="range" id="min_attack" name="min_attack" value=<?php echo isset($_SESSION['min_atk']) ? $_SESSION['min_atk'] : 0; ?> max="190" onchange="this.previousSibling.previousSibling.innerHTML='Min. Attack: '+this.value;">
                            </div>
                            <div class="individual_slider_block min_defense">
                                <!-- defense max = 250 -->
                                <p class="slider_text">Min. Defense: <?php echo isset($_SESSION['min_def']) ? $_SESSION['min_def'] : 0; ?></p>
                                <input type="range" id="min_defense" name="min_defense" value=<?php echo isset($_SESSION['min_def']) ? $_SESSION['min_def'] : 0; ?> max="250" onchange="this.previousSibling.previousSibling.innerHTML='Min. Defense: '+this.value;">
                            </div>
                            <div class="individual_slider_block min_hp">
                                <!-- hp max = 255 -->
                                <p class="slider_text">Min. HP: <?php echo isset($_SESSION['min_hp']) ? $_SESSION['min_hp'] : 0; ?></p>
                                <input type="range" id="min_hp" name="min_hp" value=<?php echo isset($_SESSION['min_hp']) ? $_SESSION['min_hp'] : 0; ?> max="255" onchange="this.previousSibling.previousSibling.innerHTML='Min. HP: '+this.value;">
                            </div>
                        </div>
                        <div class="slider_row">
                            <div class="individual_slider_block min_sp_attack">
                                <!-- sp attack max = 194 -->
                                <p class="slider_text">Min. Sp. Attack: <?php echo isset($_SESSION['min_spa']) ? $_SESSION['min_spa'] : 0; ?></p>
                                <input type="range" id="min_sp_attack" name="min_sp_attack" value=<?php echo isset($_SESSION['min_spa']) ? $_SESSION['min_spa'] : 0; ?> max="194" onchange="this.previousSibling.previousSibling.innerHTML='Min. Sp. Attack: '+this.value;">
                            </div>
                            <div class="individual_slider_block min_sp_defense">
                                <!-- sp defense max = 250 -->
                                <p class="slider_text">Min. Sp. Defense: <?php echo isset($_SESSION['min_spd']) ? $_SESSION['min_spd'] : 0; ?></p>
                                <input type="range" id="min_sp_defense" name="min_sp_defense" value=<?php echo isset($_SESSION['min_spd']) ? $_SESSION['min_spd'] : 0; ?> max="250" onchange="this.previousSibling.previousSibling.innerHTML='Min. Sp. Defense: '+this.value;">
                            </div>
                            <div class="individual_slider_block min_speed">
                                <!-- speed max = 200 -->
                                <p class="slider_text">Min. Speed: <?php echo isset($_SESSION['min_speed']) ? $_SESSION['min_speed'] : 0; ?></p>
                                <input type="range" id="min_speed" name="min_speed" value=<?php echo isset($_SESSION['min_speed']) ? $_SESSION['min_speed'] : 0; ?> max="200" onchange="this.previousSibling.previousSibling.innerHTML='Min. Speed: '+this.value;">
                            </div>
                        </div>
                    </div>
            ...
            <div class="results_block"> 
                <?php
                    $res = $mysqli->query("SELECT DISTINCT LOWER(Pokemon.Name) FROM Filtered, Pokemon WHERE ID=Filtered.Poke_Num AND Player='" . $_SESSION['user'] . "'");
                    while($row = mysqli_fetch_assoc($res)) {
                    ?>
                    <img class="selected_poke_img" onclick="window.location='./insertpoke.php?id=<?php echo $row['LOWER(Pokemon.Name)']?>'" src="./images/<?php echo $row['LOWER(Pokemon.Name)'] ?>.png">
                <?php } ?>
            </div>
        </div>
    </div> 
